...
<head>
    ...
    <title>@yield('title') - SIAKAD SD</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}">SIAKAD SD</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('ppdb') }}"><i class="fas fa-user-graduate"></i> PPDB</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('contact') }}"><i class="fas fa-address-book"></i> Kontak</a></li>
